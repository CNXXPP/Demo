...
<script type="text/javascript" src="lib/My97DatePicker/4.8/WdatePicker.js"></script>
	...
	$(function() {
					...
					.dataTable(
							{
								...
								ajax : function(data, callback, settings) {
									...
									$
											.ajax({
												type : "post",
												url : "grj/message/receiveMessage",
												cache : false, //禁用缓存
												data : param, //传入组装的参数
												dataType : "json",
		...
		function showContext(a) {
			...
			$("#context").text(data.SMSG_CONTEXT);
			 
			$("#dialog").dialog("open");
			  
			  
			  
			if(data.SMSG_STATUS == "未查看"  ){
				
			$.post("grj//message/changeState",{"smsgUuid":data.SMSG_UUID},
     			   function(datas){
     		      if(datas.result == "success"){
     		    	var num=parent.document.getElementById("messNum");
     		    	num.innerHTML=parseInt(num.innerHTML)-1;
     		    	 location = "jsp/studentSystem/receiveMessage.jsp";
