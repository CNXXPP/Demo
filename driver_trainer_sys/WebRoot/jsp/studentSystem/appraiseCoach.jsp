...
<title>My JSP 'appraiseCoach.jsp' starting page</title>
		    ...
		    var lang = {
						...
						.dataTable(
								{
									...
									ajax : function(data, callback, settings) {
										...
										$.ajax({
											type : "post",
											url : "grj/appraise/trainerAppraise",
											cache : false, //禁用缓存
											data : param, //传入组装的参数
											dataType : "json",
											success : function(result) {
												...
												/*以下动态添加  教练的资料*/
												$("#teaName").text(result.data[0].TRA_NAME);
												$("#score").text(result.data[0].TRA_SCORE);
												callback(result);
											}
										});
									},
			   ...
			   /*验证学生评分是否合法  */
				...
				$("#btnSure").click(function(){
					 ...
					 $.post("grj/appraise/addTrainerAppraise",
							 {"tcComment":$("#text").val(),"tcScore":$("#pscore").val()},
							 function(data){
								 
								 var msg = data.message;
								 alert(msg);
								 
								  if(msg == '抱歉你已经评价过这个教练了'){
									  $("#text").val("");
									  $("#pscore").val("");
									  $("#dialog").css("display", "none");
								 }else if(msg == '评价成功,感谢你的反馈'){
									location="jsp/studentSystem/appraiseCoach.jsp";
								 }
