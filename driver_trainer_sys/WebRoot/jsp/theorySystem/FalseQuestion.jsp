...
<body >
	...
	<div>
	<iframe id="tt1" src="/driver_trainer_sys/jsp/theorySystem/FirstFalse.jsp" width="100%" height="100%" frameborder="no" scrolling="yes"></iframe>
	</div>
	...
	<script type="text/javascript">
	    function aaa(){
	         $("#tt1").attr('src',"/driver_trainer_sys/jsp/theorySystem/FirstFalse.jsp");
	         $("#span").text("第一部分");
	    }
	    
	    function bbb(){
	        $("#tt1").attr('src',"/driver_trainer_sys/jsp/theorySystem/ForthFalse.jsp");
	        $("#span").text("第四部分");
	    }
	</script>
</body>
