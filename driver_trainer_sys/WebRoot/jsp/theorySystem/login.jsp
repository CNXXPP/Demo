...
<base href="<%=basePath%>"> 
    ...
    <body >
        <div >
        <h1 style="font-size:50px">机动车驾驶员网上理论学习平台</h1>
        </div>
        ...
        <div class="page-container">
            ...
            <form>
                ...
                <img src="/driver_trainer_sys/CZX/Login/theoryAuthCode" width=100px height=40px title="点击更换" alt="验证码占位图" onclick="theoryAuthCode(this)"/>
        ...
        <script type="text/javascript" >
            ...
            function login(){
                ...
                $.post("/driver_trainer_sys/CZX/Login/theoryLogin",{"stuIdentity":username,"stuPwd":password,"inputcode":code},
                                                          function(data){
                                                              if(data.result=="wrongIdentity"){
                                                                  alert("提示：身份证号码不存在");
                                                                  $("#wrong").css("top","27px");
                                                                  $("#wrong").css("display","block");
                                                              ...
                                                              else if(data.result=="wrongcode"){
                                                                  alert("提示：验证码输入有误");
                                                                  $("#wrong").css("top","167px");
                                                                  $("#wrong").css("display","block"); 
                                                              }else if(data.result=="loginSec"){
//                                                                   alert("提示：正在登录");
                                                                  location= "/driver_trainer_sys/jsp/theorySystem/index.jsp";
                                                              }
                                                          });
           }
            ...
            function theoryAuthCode(image){
                ...
                image.src = "/driver_trainer_sys/CZX/Login/theoryAuthCode?date=" + new Date().getTime();
            };
       </script>
    </body>
