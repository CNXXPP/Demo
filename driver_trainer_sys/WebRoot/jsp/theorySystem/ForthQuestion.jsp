...
<html>
  ...
  <body>
    ...
    <div style="position:absolute;top:0px;left:0px;width:100%;height:150px;">
        <div style="position:absolute;left:40px;top:5px">
            <span id="aa" style="display:none">科目四</span><span id="qq" style="font-size:23px"></span>    <span id="pg0" style="font-size:23px"></span>
        </div>
    </div>
  ...
  <script type="text/javascript">
      $(function(){
      $.post("/driver_trainer_sys/CZX/QuestionTest/getQuestion",{"subject":"科目四"},function(data){
