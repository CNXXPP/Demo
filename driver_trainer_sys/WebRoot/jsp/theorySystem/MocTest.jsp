...
ul li{width:40px;float:left;margin-right:2px;margin-top:2px;line-height:30px;border:1px solid black;}
  ...
  <div>
    ...
    <div style="position:absolute;top:1%;left:1%;width:16%;height:17%;background-color:#E0FFFF">
        <span>科目一考场：</span></br></br>&nbsp;&nbsp;&nbsp;<span style="font-size:23px">模拟考场</span>
    </div>
  ...
  <script type="text/javascript">
      ...
      function aa(obj){
           ...
           $("#answer").html("");
           $.post("/driver_trainer_sys/CZX/QuestionTest/nextQuestion",{"qno":id,"subject":"科目一"},function(data){
   ...
   var timer;
    ...
    $("#time").prop("innerHTML",min+":"+sec); 
        ...
        timer=setInterval("lastTime()", "1000");     
         ...
         //生成不重复 随机数
         for(var q = 0; q < 50; q++){
             rand = Math.floor(Math.random() * 107) ;
         ...
         $.post("/driver_trainer_sys/CZX/QuestionTest/nextQuestion",{"qno":arr[0],"subject":"科目一"},function(data){
