...
<body>
	...
	<div class="Hui-article">
		...
		<div>
			...
			<h2 style="display:inline">所有驾校信息</h2>
...
<!-- 				<h3 id="name"></h3> -->
		...
		&nbsp;&nbsp;&nbsp;(可选)驾校名 ：&nbsp;&nbsp;&nbsp;<input id="n"  type='value'>
		&nbsp;&nbsp;&nbsp;(可选)驾校地址 :&nbsp;&nbsp;&nbsp; <input id="loc"  type='value'>
		&nbsp;&nbsp;&nbsp;(可选)联系方式 :&nbsp;&nbsp;&nbsp; <input id="contact"  type='value' >
	...
	<script type="text/javascript">
					...
					.dataTable(
							{
								...
								ajax : function(data, callback, settings) {
									...
									$.ajax({
										type : "post",
										url : "xp/centerSchoolMgr/showAllSchool",
										cache : false, //禁用缓存
										data : param, //传入组装的参数
										dataType : "json",
		...
		function delFromID(a) {
			...
			if (confirm("确定要删除该属性？")) {
				...
				$.post("xp/centerSchoolMgr/delSchool", {
					"schId" : schId
				}, function(msg) {
					msg = msg.result;
// 					alert(msg);
		...
		function resetPwd(a) {
			...
			if (confirm("确定重置该用户密码？")) {
				var pwd = prompt("请输入管理员密码:");
				// 		        	if(pwd == ${admin.admPwd}){
				$.post("xp/centerSchoolMgr/resetPwd", {
					"schId" : schId
				}, function(msg) {
					//alert(msg);
					msg = msg.result;
		...
		function submitChange(){
			var schId= $("#id").val()
			var schName = $("#n").val();
			var schLocation = $("#loc").val();
			var schPhone = $("#contact").val();
			$.post("xp/centerSchoolMgr/updateSchoolInfo",{"schId":schId,"schName":schName,"schLocation":schLocation,"schPhone":schPhone},function(msg){
