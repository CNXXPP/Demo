...
<body>
	...
	<div class="Hui-article">
		...
		<div>
			...
			<h2 style="display:inline">所有公告</h2>
								...
								columnDefs : [
										{
											...
											render : function(data, type, row,
													meta) {
												return '<a type="button" class="btn btn-danger" onclick=delFromID(this) >删除</a>';
											}
										}, {
											"orderable" : false,
											"targets" : 4
