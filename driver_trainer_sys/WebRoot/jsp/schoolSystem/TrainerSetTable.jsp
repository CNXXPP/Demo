...
<title>My JSP 'TrainerSetTable.jsp' starting page</title>
...
<body>
	...
	<div class="Hui-article">
		...
		<div>
			...
			<h2 style="display:inline">教练安排</h2>
		...
		<div id="textDiv">
			...
			&nbsp;&nbsp;&nbsp;id ：&nbsp;&nbsp;&nbsp;<input id="uuid" type='value'
					disabled="true"> 
				&nbsp;&nbsp;&nbsp;学号 ：&nbsp;&nbsp;&nbsp;<input id="id" type='value'
					disabled="true"> &nbsp;&nbsp;&nbsp;姓名 ：&nbsp;&nbsp;&nbsp;<input
					id="n" type='value' disabled="true">
				&nbsp;&nbsp;&nbsp;教练:&nbsp;&nbsp;&nbsp; <select id="tra"
					> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select>
			...
			success : function(data) {
			  ...
			  var str = "";
				...
				for (var i = 0; i < tra.length; i++) {
					...
					str += "<option value='"+tra[i].traUuid+"'>"+tra[i].traName+"</option>";
								...
								columnDefs : [
										{
											...
											render : function(data, type, row,
													meta) {
												return '<a type="button" class="btn btn-success" onclick=updateById(this) >安排教练</a>';
											}
										}, {
											"orderable" : false,
											"targets" : 3
...
function updateById(a) {
			...
			$("#uuid").attr("value",stuUuid);
			$("#id").attr("value",stuId);
			$("#n").attr("value",stuName);
			
		}
		function submitChange() {
			var stuUuid = $("#uuid").val();
			var traUuid = $("#tra").val();
		
			$.post("jjn/giveTrainer", {
				"stuUuid" : stuUuid,
				"traUuid" : traUuid,
